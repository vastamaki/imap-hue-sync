export = Schedules;
declare const Schedules_base: {
    new (hueApi: any): import("./http/ApiDefinition");
};
declare class Schedules extends Schedules_base {
     ...
     */
    getAll(): Promise<import("../model/Schedule")[]>;
    /**
     * @deprecated Use getSchedule(id) instead
     * @param id {int | Schedule}
     * @returns {Promise<Schedule>}
     */
    get(id: any): Promise<import("../model/Schedule")>;
    /**
     ...
     */
    getSchedule(id: any): Promise<import("../model/Schedule")>;
    /**
     *
     * @param name
     * @returns {Promise<Schedule[]>}
     */
    getScheduleByName(name: any): Promise<import("../model/Schedule")[]>;
    /**
     ...
     */
    createSchedule(schedule: import("../model/Schedule")): Promise<import("../model/Schedule")> | PromiseLike<import("../model/Schedule")>;
    /**
     * Updates a Schedule.
     ...
     */
    updateSchedule(schedule: import("../model/Schedule")): Promise<any>;
    /**
     ...
     */
    deleteSchedule(id: any): Promise<boolean>;
}
declare namespace Schedules {
    export { Schedule };
}
type Schedule = import("../model/Schedule");
