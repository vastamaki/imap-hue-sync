...
declare class RemoteApi {
     ...
     * @returns {RemoteApi}
     */
    setAccessToken(token: string, expiry?: number): import("./RemoteApi");
    /**
     ...
     * @returns {RemoteApi}
     */
    setRefreshToken(token: string, expiry?: number): import("./RemoteApi");
    /**
     ...
     */
    createRemoteUsername(remoteBridgeId?: number, deviceType?: string): Promise<string>;
    /** @private */
    _respondWithDigest(err: any, requestConfig: any): any;
    /** @private */
    _processTokens(start: any, data: any): import("./OAuthTokens");
}
