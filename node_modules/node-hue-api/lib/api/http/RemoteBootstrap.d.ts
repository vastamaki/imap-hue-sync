...
declare class RemoteBootstrap {
     ...
     * @returns {Promise<Api>}
     */
    connectWithCode(code: string, username?: string, timeout?: number, deviceType?: string, remoteBridgeId?: number): Promise<import("../Api")>;
    /**
     ...
     * @returns {Promise<Api>}
     */
    connectWithTokens(accessToken: string, refreshToken: string, username?: string, timeout?: number, deviceType?: string): Promise<import("../Api")>;
    /** @private */
    _getRemoteApi(username: any, timeout: any): any;
}
