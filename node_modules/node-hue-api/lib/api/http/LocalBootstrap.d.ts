export = LocalBootstrap;
declare class LocalBootstrap {
    /**
     ...
     */
    connect(username?: string, clientkey?: string, timeout?: number): Promise<import("../Api")>;
}
declare namespace LocalBootstrap {
    export { exports };
}
type exports = any;
