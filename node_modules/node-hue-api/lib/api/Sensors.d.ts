...
declare class Sensors extends Sensors_base {
     ...
     */
    updateSensorConfig(sensor: import("../model/sensors/Sensor")): Promise<any>;
    /**
     ...
     * @returns {Promise<Object>}
     */
    updateSensorState(sensor: import("../model/sensors/Sensor"), limitToStateNames: string[]): Promise<any>;
}
