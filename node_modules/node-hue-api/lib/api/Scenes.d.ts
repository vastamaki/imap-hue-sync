...
declare class Scenes extends Scenes_base {
     ...
     */
    updateScene(scene: import("../model/scenes/LightScene") | import("../model/scenes/GroupScene")): Promise<any>;
    /**
     ...
     * @returns {Promise<object>}
     */
    updateLightState(id: string | import("../model/scenes/LightScene") | import("../model/scenes/GroupScene"), lightId: any, sceneLightState: any): Promise<any>;
    /**
