...
describe('UInt8Type', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create a type', () => {
      const name = 'my_int_type'
        , type = new UInt8Type({name: name})
      ;

      expect(type).to.have.property('name').to.equal(name);
      expect(type).to.have.property('type').to.equal('uint8');
    });
  });
  ...
  describe('not optional, with default and different max/min values', () => {
    ...
    it('should process 12.9999 as 12', () => {
      expect(intType.getValue(12.9999)).to.equal(12);
    });
